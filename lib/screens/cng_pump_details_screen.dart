...
class CngStationDetailScreen extends StatelessWidget {
  final PetrolPump pump;

  const CngStationDetailScreen({super.key, required this.pump});
                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("Rs ${pump.cngPrice}", style: const TextStyle(fontSize: 16)),
                              Text(
                                pump.status,
                                style: TextStyle(
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                const Text("CNG", style: TextStyle(fontWeight: FontWeight.bold)),
                                const SizedBox(height: 4),
                                Text("₹ ${pump.cngPrice.toStringAsFixed(2)}/Kg", style: const TextStyle(fontSize: 16)),
                              ],
                            ),
                          ),
                        ),
