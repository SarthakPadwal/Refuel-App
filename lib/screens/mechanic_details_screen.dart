...
class MechanicDetailScreen extends StatelessWidget {
  ...
  const MechanicDetailScreen({super.key, required this.pump});
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  color:
                                  pump.status.toLowerCase().contains('open')
                                      ? Colors.green
                                      : Colors.red,
                                  fontWeight: FontWeight.bold,
                                ),
                              ...
                              Row(
                                children: List.generate(
                                  getCrowdPeopleCount(pump.crowd),
                                      (index) => Icon(
                                    Icons.people,
                                    color: getCrowdColor(pump.crowd),
                                    size: 25,
                                  ),
                                ),
                              ),
                            ...
                            child: Column(
                              children: const [
                                Text(
                                  ...
                                  style: TextStyle(fontWeight: FontWeight.bold),
                                  textAlign: TextAlign
                                      .center, // ✅ Ensure multi-line center
                                ),
                                SizedBox(height: 4),
                              ],
                            ),
                    ...
                    Wrap(
                      ...
                      runSpacing: 10,
                      children: [
                        amenityChip("Pickup & Drop ", Icons.access_time),
                        amenityChip("Washroom ", Icons.wc),
                        amenityChip("Lounge ", Icons.store),
                      ],
                    ),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(
                              pump.rating?.toStringAsFixed(1) ?? "N/A",
                              style: const TextStyle(fontSize: 16),
                            ),
                          ],
                        ),
